      ...
      <div className="max-w-[1240px] mx-auto px-2 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-8 m-6">
          ...
          <div className="m-8 p-8">
            ...
            <p className="m-6">
            "OpenStream" is a project within the LangChain ecosystem that seamlessly integrates various tools powered by OpenAI's language models. This multifaceted platform offers a range of functionalities, including real-time streaming capabilities, efficient PDF conversion, and intelligent summarization.
            </p>
            <div className="flex">
              <Link href="https://netflix-reactjs-f2e51.web.app">
                <button className="px-8 py-2 m-8 mt-4 mr-8">Live Demo</button>
            ...
            <div className="m-8 p-8">
              ...
              <p className="m-6">
                This is my first UI/UX project I built it with Figma, React and
                JS as well. We created a functional booking system for the
                little lemon restaurant with fully pleged Wireframing and
                Prototyping concepts in Figma. I have the links for both source
                code and wireframes below.
              </p>
            </div>
              <div>
              <ProjectItem
